  ...
  */
  ...
  string OBMol::GetSpacedFormula(int ones, const char* sp, bool implicitH)
  {
    ...
    const int alphabetical[NumElements] = {
      ...
      58, 98, 17, 96, 112, 27, 24, 55, 29, 105, 110, 66, 68, 99, 63, 9, 26, 114, 100, 87, 31,
      ...
      62, 50, 38, 73, 65, 43, 52, 90, 22, 81, 69, 117, 92, 23, 74, 54, 39, 70,
      30, 40, NumElements-1, NumElements };
